import{b as h,r as c,j as e,L as t}from"./app-BYcjejbU.js";function v({user:a,children:f}){const{url:p}=h(),[i,s]=c.useState(!1),d=c.useRef(null),o=n=>{try{return route(n)}catch{return"#"}},l=a?.role==="owner",x=[{href:o("dashboard.index"),label:"Beranda",icon:"🏠"},{href:o("dashboardkeuangan"),label:"Keuangan",icon:"💵"},...l?[{href:o("audit.index"),label:"Audit Log",icon:"🔐"}]:[]],g=n=>{try{const r=new URL(n).pathname;return p===r||p.startsWith(r+"/")}catch{return!1}};return c.useEffect(()=>{const n=r=>{d.current&&!d.current.contains(r.target)&&s(!1)};return document.addEventListener("mousedown",n),()=>document.removeEventListener("mousedown",n)},[]),e.jsxs("div",{style:{minHeight:"100vh",background:"#f8f9fa",fontFamily:"'Google Sans', 'Segoe UI', sans-serif"},children:[e.jsx("style",{children:`
